...
public class NotificationUtils {
    ...
    private static Action ignoreReminderAction(Context context) {
        ...
        Action action = new Action(R.drawable.ic_cancel_black_24px, "Dismiss", pendingIntent);
        return action;
    }
    ...
    private static Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context, 245, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        Action action = new Action(R.drawable.ic_local_drink_black_24px, "I drink it", pendingIntent);
        return action;
    }
