...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String URL_VALUE = mUrlDisplayTextView.getText().toString();
        String JSON_VALUE = mSearchResultsTextView.getText().toString();

        outState.putString(URL_KEY, URL_VALUE);
        outState.putString(JSON_KEY, JSON_VALUE);
